...
export const listaRealizacoes: Realizacao[] = [
  {
    ...
    descricao:
      "Desde o ensino médio já participava do projeto de divulgação científicia 'A Magia da Física', que desde 2017 realiza o Pint of Science, o maior evento de divulgação científica do mundo, em Lavras. Porém em 2022 tive a honra de ser organizador do eveto, o primeiro presencial depois da pandemia.",
  },
  {
    titulo: "98 no TCC",
    imagem: "/tcc.webp",
  ...
  },
  {
    ...
    imagem: "/nave.webp",
    descricao:
      "Durante minha carreira na Vega tive a oportunidade de ser mentor de cinco pessoas boas de serviço no projeto NAVE, oferecido pela Oi Futuro. Foi muito gratificante ver que todos eles foram efetivados no final do projeto.",
  },
  {
    titulo: "Outros",
    imagem: "/outros.webp",
